...
class PyleniumConfig(metaclass=Singleton):
    __browser = os.getenv('pylenium_browser', Browser.CHROME)
    __headless = os.getenv('pylenium_headless', False)
    __remote = os.getenv('pylenium_remote', False)
    __browser_size = os.getenv('pylenium_browser_size', '1366x768')
    __browser_version = os.getenv('pylenium_browser_version', None)
    __browser_position = os.getenv('pylenium_browser_position', None)
    __browser_maximized = os.getenv('pylenium_maximized', True)
    __wdm_enabled = os.getenv('pylenium_wdm_enabled', True)
    __browser_binary = os.getenv('pylenium_browser_binary', '')
    __page_load_strategy = os.getenv('pylenium_page_load_strategy', PageLoadStrategy.NORMAL)
    __desired_capabilities = DesiredCapabilities()
    __base_url = os.getenv('pylenium_base_url', 'http://localhost:8080')
    __explicit_wait_timeout = os.getenv('pylenium_wait_timeout', 15000)
    __polling_timeout = os.getenv('pylenium_polling_timeout', 200)
    __capture_screenshot = os.getenv('pylenium_screenshot', True)
    __capture_pagesource = os.getenv('pylenium_pagesource', True)
    __javascript_clicking = os.getenv('pylenium_js_click', False)
    __javascript_sendkeys = os.getenv('pylenium_js_sendkeys', False)
